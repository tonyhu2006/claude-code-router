...
async function testFixedConfig() {
  console.log('🧪 测试修复后的Gemini Balance配置...\n');
  
  const tests = [
    {
      name: '测试默认路由 (gemini,gemini-2.5-flash)',
      model: 'claude-3-5-sonnet-20241022',
      content: 'Hello! Please respond briefly.'
    },
    {
      name: '测试直接指定 gemini,gemini-2.5-flash',
      model: 'gemini,gemini-2.5-flash',
      content: 'Hello! Please respond briefly.'
    },
    {
      name: '测试直接指定 gemini,gemini-2.5-pro',
  ...
  console.log('🏁 测试完成!');
  console.log('\n💡 现在应该使用正确的基础URL:');
  console.log('   - API Base URL: http://84.8.145.89:8000');
  console.log('   - 端点会自动添加: /v1/chat/completions');
}
